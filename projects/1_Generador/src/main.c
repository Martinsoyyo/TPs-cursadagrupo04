...
void applicationIface_opOnlyLed(const Application* handle, const sc_integer LED){
	switch (LED){
		case LED0_R:
			Board_LED_Set(LED0_R, 1);
			Board_LED_Set(LED0_G, 0);
			Board_LED_Set(LED0_B, 0);
			break;
		case LED0_G:
			Board_LED_Set(LED0_R, 0);
			Board_LED_Set(LED0_G, 1);
			Board_LED_Set(LED0_B, 0);
			break;
		case LED0_B:
			Board_LED_Set(LED0_R, 0);
			Board_LED_Set(LED0_G, 0);
			Board_LED_Set(LED0_B, 1);
			break;
	}
}
