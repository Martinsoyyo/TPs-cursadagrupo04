...
#include "../../5_Horno_Microondas/inc/main.h"

#include "../../5_Horno_Microondas/gen/Application.h"
#include "../../5_Horno_Microondas/inc/TimerTicks.h"
...
void applicationIface_opCook(const Application* handle, const sc_integer Mode, const sc_boolean State)
{};
