...
#define SCVI_APPLICATION__REGION2_OFF 2
#define SCVI_APPLICATION__REGION2_IN_MOTION 2
#define SCVI_APPLICATION__REGION2_IN_MOTION__REGION0_LOW_FLOOR 2
#define SCVI_APPLICATION__REGION2_IN_MOTION__REGION0_HIGH_FLOOR 2
...
typedef enum
{
	...
	Application__region2_OFF,
	Application__region2_IN_MOTION,
	Application__region2_IN_MOTION__region0_LOW_FLOOR,
	Application__region2_IN_MOTION__region0_HIGH_FLOOR
} ApplicationStates;
...
typedef struct
{
	...
	sc_boolean ev_presence_up_raised;
	sc_boolean ev_presence_down_raised;
} ApplicationIface;
...
extern const sc_boolean APPLICATION_APPLICATIONIFACE_UP;
extern const sc_boolean APPLICATION_APPLICATIONIFACE_DOWN;
...
extern sc_boolean applicationIface_get_uP(const Application* handle);
/*! Gets the value of the variable 'DOWN' that is defined in the default interface scope. */ 
extern sc_boolean applicationIface_get_dOWN(const Application* handle);
...
/*! Raises the in event 'ev_presence_up' that is defined in the default interface scope. */ 
extern void applicationIface_raise_ev_presence_up(Application* handle);

/*! Raises the in event 'ev_presence_down' that is defined in the default interface scope. */ 
extern void applicationIface_raise_ev_presence_down(Application* handle);
